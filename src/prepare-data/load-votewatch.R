...
# 04/2019 Nejat Arinik => changed only the line 380: 'result$rollcall.details <- vw.clean.doc.details()' 
#############################################################################################
...
#############################################################################################
GROUP.VW2SYMB <- c()
GROUP.VW2SYMB["tertiary"] <- GROUP.TERT
GROUP.VW2SYMB["secondary/primary"] <- GROUP.SECPRI
...
{	tlog("***************************************************")
	...
	result$rollcall.details <- vw.clean.doc.details()
